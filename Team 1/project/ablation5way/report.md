...
고정 예시 5개 삽입. 역할 지정·번역 원칙·패턴 주입 없이 어투 참고 지시만 포함.
...
[번역 예시]
- 또 아뢰기를, "대사헌 김간, ... 감히 아룁니다." 하니, 알았다고 전교하였다.
- 경성회가 도총부의 말로 아뢰기를, "... 표신을 내주소서." 하니, 알았다고 전교하였다.
- 이현록이 아뢰기를, "... 시사를 탈품합니다." 하니, 알았다고 전교하였다.
- 또 아뢰기를, "관학 유생의 상소가 ... 감히 아룁니다." 하니, 들이라고 전교하였다.
- 또 아뢰기를, "홍문관이 입직을 ... 어떻겠습니까?" 하니, 윤허한다고 전교하였다.
...
**특징 및 한계**:
- 예시 5개 전부 아뢰기/전교 패턴 — 단일 패턴 편향
- 번역 원칙·어휘 제약 없음 (종결어미, 왕 지칭 등 명시 안 함)
- 인물명 음독 교정 없음 → NER recall 하락 원인
